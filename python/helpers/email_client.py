...
class EmailClient:
    ...
    async def read_messages(
        ...
        Args:
            download_folder: Folder to save attachments (relative to /home/shayne/agent-zero/)
    ...
    def _html_to_text(self, html_content: str, cid_map: Optional[Dict[str, str]] = None) -> str:
        ...
        Replaces inline images with [file:///home/shayne/agent-zero/...] markers to maintain
        positional context.
        """
        cid_map = cid_map or {}
