...
const model = {
  ...
  getServerImgUrl(filename) {
    return `/image_get?path=/home/shayne/agent-zero/tmp/uploads/${encodeURIComponent(filename)}`;
  },

  getServerFileUrl(filename) {
    return `/home/shayne/agent-zero/tmp/uploads/${encodeURIComponent(filename)}`;
  },
